...
export default function TopNav() {
  return (
    <nav className="fixed top-0 left-0 w-full z-50 flex h-16 md:h-20 shrink-0 items-center justify-between gap-4 glass-celestial px-4 md:px-10 shadow-celestial backdrop-blur-xl">
      <div className="text-display-lg !text-2xl text-primary font-light uppercase tracking-[0.2em] atmos-glow">MyTime</div>
